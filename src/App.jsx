...
function App() {
  return (
    <div 
      className="bg-gray-100 min-h-screen flex justify-center items-center py-8 relative"
    >
      {/* Glow container */}
      <div className="relative group">
      {/* Glow effect */}
      <div 
  className="absolute -inset-0.5 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-glow"
  style={{
    backgroundImage: 'linear-gradient(45deg, #FE5D26, #34A353, #F6B704, #4280EF)'
  }}
></div>
      <div className="bg-white p-8 rounded-lg shadow-lg w-80 sm:w-96 md:w-full relative glow-effect" >
